...
struct EventTrieNode *EventTrie_InitNode(struct EventTrieNode *Node, struct EventListNode *EventList);
...
struct EventTrieNode *EventTrie_CreateNode(struct EventListNode *EventList) {
	return EventTrie_InitNode(malloc(sizeof (struct EventTrieNode)), EventList);
}
